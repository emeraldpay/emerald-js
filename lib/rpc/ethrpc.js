  ...
  var EthApi = function () {
    ...
    _createClass(EthApi, [{
      ...
      value: function getTransactionCount(address) {
        ...
        return this.rpc.call('eth_getTransactionCount', [address, blockNumber]).then(function (result) {
          return _convert2.default.toNumber(result);
        });
      }
    }, {
      ...
      value: function getTransaction(hash) {
        return this.rpc.call('eth_getTransactionByHash', [hash]).then(function (tx) {
          return _format2.default.transaction(tx);
        });
      }
    }]);
