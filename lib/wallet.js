(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'ethereumjs-wallet', 'ethereumjs-util', 'ethereumjs-tx', './convert'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('ethereumjs-wallet'), require('ethereumjs-util'), require('ethereumjs-tx'), require('./convert'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.ethereumjsWallet, global.ethereumjsUtil, global.ethereumjsTx, global.convert);
    global.wallet = mod.exports;
  }
})(this, function (exports, _ethereumjsWallet, _ethereumjsUtil, _ethereumjsTx, _convert) {
  'use strict';
