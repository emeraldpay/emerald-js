(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'ethereumjs-util', 'qs'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('ethereumjs-util'), require('qs'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.ethereumjsUtil, global.qs);
    global.transactionUri = mod.exports;
  }
})(this, function (exports, _ethereumjsUtil, _qs) {
  'use strict';
