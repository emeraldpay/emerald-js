    ...
    _createClass(NodeChecker, [{
      ...
      value: function getChain() {
        ...
        return new Promise(function (resolve, reject) {
          _this.ethRpc.eth.getBlockByNumber('0x0', false).then(function (result) {
            if (result.hash === NodeChecker.ETC_MAINNET_GENESIS) {
              // try to detect ethereum fork
              _this.ethRpc.eth.getBlockByNumber(_convert2.default.toHex(2000000)).then(function (block2000000) {
                if (block2000000) {
