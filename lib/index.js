(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', './convert', './wei', './rpc/jsonrpc', './rpc/transport', './rpc/ethrpc', './nodeChecker', './address', './vault', './vault/providers/memory', './vault/providers/rpc'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('./convert'), require('./wei'), require('./rpc/jsonrpc'), require('./rpc/transport'), require('./rpc/ethrpc'), require('./nodeChecker'), require('./address'), require('./vault'), require('./vault/providers/memory'), require('./vault/providers/rpc'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.convert, global.wei, global.jsonrpc, global.transport, global.ethrpc, global.nodeChecker, global.address, global.vault, global.memory, global.rpc);
    global.index = mod.exports;
  }
})(this, function (exports, _convert, _wei, _jsonrpc, _transport, _ethrpc, _nodeChecker, _address, _vault, _memory, _rpc) {
  'use strict';
